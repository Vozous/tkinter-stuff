...
canvas_original = tk.Canvas(win, width=600, height=600)
canvas_original.place(x=cx//2-(600//4), y=cy)

canvas_edited = tk.Canvas(win, width=600, height=600)
canvas_edited.place(x=cx+(cx//(2)-600//4), y=cy)
